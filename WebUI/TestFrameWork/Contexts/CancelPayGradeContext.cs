...
{
    public class CancelPayGradeContext : DefaultContext
    {
        ...
        public CancelPayGradeContext(IWebDriver driver) :base(driver)
        {
        ...
        public string CheckTheDataIsNotVisible()
        {
            ...
            return _payGradepage.PayGradesPageAll.GetAttribute("innerText");
        }
    }
}
